...
<head>
  ...
  <title>SJC Student Management System</title>
...
<body>
  ...
  <div id="wrapper">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      ...
      <div class="navbar-header" style="background-color: #C70039 ">
        ...
        <a class="navbar-brand" href=""><b>&nbsp;&nbsp;&nbsp;SJC STUDENT
            MANAGEMENT SYSTEM</b></a>
      </div>
      <!-- Top Menu Items -->
      <ul class="nav navbar-right top-nav" style="background-color: #C70039 ">
        <li class="dropdown">
      ...
      <div class="collapse navbar-collapse navbar-ex1-collapse" style="background-color: #C70039 ">
        <?php
        include 'db.php';
